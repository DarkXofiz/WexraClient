package dev.wexra.screens.dropdown;
...
import dev.wexra.manager.themeManager.Style;
import dev.wexra.modules.Function;
import dev.wexra.modules.Type;
import dev.wexra.modules.setting.*;
import dev.wexra.protect.AES;
import dev.wexra.screens.dropdown.impl.*;
import dev.wexra.screens.dropdown.search.SearchState;
import dev.wexra.util.animations.impl.EaseInOutQuad;
...
import static dev.wexra.util.render.RenderUtil.drawBlur;
...
public class ClickGUI extends Screen implements IMinecraft {
    ...
    private void renderPanel(DrawContext ctx, int x, int y, Type category, int mouseX, int mouseY) {
        ...
        for (Function f : Manager.FUNCTION_MANAGER.getFunctions(category)) {
            ...
            dev.wexra.modules.render.ClickGUI clickGUI = Manager.FUNCTION_MANAGER.clickGUI;
