...
import dev.wexra.mixin.iface.ItemCooldownEntryAccessor;
import dev.wexra.mixin.iface.ItemCooldownManagerAccessor;
import dev.wexra.modules.setting.*;
...
import dev.wexra.util.animations.Animation;
import dev.wexra.util.animations.impl.EaseBackIn;
import dev.wexra.util.color.ColorUtil;
import dev.wexra.manager.fontManager.FontUtils;
import dev.wexra.util.math.MathUtil;
import dev.wexra.util.player.ServerUtil;
import dev.wexra.util.render.ColorRGBA;
import dev.wexra.util.render.RenderAddon;
import dev.wexra.util.render.RenderUtil;
import dev.wexra.util.render.Scissor;
...
import static dev.wexra.util.color.ColorUtil.hud_color;
import static dev.wexra.util.render.RenderUtil.*;
...
public class HUD extends Function {
    ...
    public final Dragging watermarkDrag = WexraClient.getInstance().createDrag(this, "WaterMark", 10, 10);
    public final Dragging targethudDrag = WexraClient.getInstance().createDrag(this, "TargetHUD", 10, 45);
    public final Dragging keybindsDrag = WexraClient.getInstance().createDrag(this, "KeyBindsHUD", 10, 95);
    public final Dragging stafflistDrag = WexraClient.getInstance().createDrag(this, "StaffListHUD", 10, 128);
    public final Dragging itemcooldownDrag = WexraClient.getInstance().createDrag(this, "CoolDownHUD", 10, 165);
    public final Dragging potionhudDrag = WexraClient.getInstance().createDrag(this, "PotionHUD", 10, 198);
    public final Dragging coordinateshudDrag = WexraClient.getInstance().createDrag(this, "CoordinatesHUD", 10, 198);
    public final Dragging armorDrag = WexraClient.getInstance().createDrag(this, "ArmorHUD", 478, 468);
    ...
    private void waterMark(EventRender2D render2D) {
        ...
        String textLogo = "WexraClient 1.21.4";
